...
export function NotFound() {
  ...
  return (
    <section className="flex min-h-screen flex-col items-start justify-center px-8 pt-16 md:px-16 lg:px-24">
      <p className="mb-4 text-xs font-medium tracking-[0.3em] uppercase text-black/60">{t("notFound.label")}</p>
